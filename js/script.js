...
/* SCROLL SKILLS */
srtop.reveal('.skills .container1 .content1 ', { interval: 200 });
srtop.reveal('.skills .container1 .info', { delay: 400 });

/* SCROLL PROJECTS */
srtop.reveal('.work .box', { interval: 200 });

/* SCROLL EXPERIENCE */
srtop.reveal('.row1 .experience .timeline', { delay: 400 });
srtop.reveal('.row1 .experience .timeline  .container', { interval: 400 });
